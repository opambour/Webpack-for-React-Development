                        ...
                        <section className="container">
                            <div className="flex-lg-12">
                                ...
                                <p>
                                    ...
                                    Illum blanditiis at culpa sint enim non beatae odit, temporibus cumque quae. Hic, iusto ipsum. Dolorum ratione illo dolor, ex sapiente dignissimos. Voluptates voluptatem, deserunt perspiciatis quis harum consequatur eligendi.
                                    Cumque, amet. Adipisci amet nostrum at nesciunt dolorem temporibus. Sed doloremque accusamus quos, optio error praesentium id officia voluptate ipsum aut vero voluptas non odio ratione molestias voluptatibus? Dignissimos, dolore!
                                </p>
                            </div>
                        </section>
                        <section className={ 'container' }>
                            ...
                            <div className="flex-lg-3">
                                <div className="card">
                                    ...
                                    <div className="card-footer">
                                        <Link linkHref={ '#' } className={ 'btn' }>Link 1</Link>
                                        <Link linkHref={ '#' } className={ 'btn' }>Link 2</Link>
                                    </div>
                                </div>
                            </div>
                        </section>
